...
def main(cfg: TrainConfig):
    ...
    model = build_sam2(cfg.model_cfg, cfg.checkpoint, device=device, n_objects=1)
    model.eval()
    model.to(device)
    ...
    for epoch in range(cfg.epochs):
        ...
        for batch in loader:
            ...
            input_image = transforms(image)       # (3,H',W'), 
...
if __name__ == "__main__":
    ...
    ap.add_argument("--training_data", required=True, type=str)
    ...
    ap.add_argument("--save_dir", default="./checkpoints/Object_tokens_demo", type=str)
