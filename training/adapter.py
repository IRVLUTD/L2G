...
# -*- coding: utf-8 -*-
"""
Train a residual MLP adapter on frozen perceptiion model.
...
ROOT_RGB = Path("../RoboTools_create_bbox/rgb")
ROOT_MSK = Path("..//RoboTools_create_bbox/mask")  # kept for index-building, but masks are not used in training
...
SAVE_ROOT = Path("../checkpoints/adapter_save_RoboTools")
